package com.automationninjatutorial.qa.base;
...
public class Base {
	...
	public Base() {
		...
		File dataPropFile = new File(System.getProperty("user.dir")+"\\src\\main\\java\\com\\automationninjatutorial\\qa\\testdata\\testdata.properties");
